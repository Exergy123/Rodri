...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    setServo(rotacion_hombro_dcho,180);
    ...
    //Impares
    setServo(codo_dcho,120);
    setServo(codo_izdo,0);
    setServo(flexion_hombro_dcho,60);
    setServo(rotacion_hombro_izdo,120);
    ...
    setServo(rotacion_hombro_dcho,45);
    ...
    //Impares
    setServo(codo_dcho,20);
    setServo(codo_izdo,60);
